...
const animationTitle = () => { 
		...
		if (typeof window !== "undefined") {
			"use strict" 
				...
				// custom code
				let scrollMoveRight2 = document.querySelectorAll(".tl_moving_section_right");
				console.log("------------",scrollMoveRight2)
				...
				let scrollMoveLeft2 = document.querySelectorAll(".tl_moving_section_left");
				debugger
				console.log(scrollMoveRight2)
			...
			let tl_startup_agency = gsap.utils.toArray(".tl_startup_agency.tl_card");
			tl_startup_agency.forEach((tl_startup) => {
				gsap.set(tl_startup, {
					opacity: 0,
					x: +100,
				});
			...
			let mark = document.querySelector(".tl_hero .anim_banner_text_left");
			let eting = document.querySelector(".tl_hero .anim_banner_text_right");
			let tl_hero_style5_subtext = document.querySelector(".tl_hero .anim_subtext");
			...
			let split_tl_hero_style5_subtext = new SplitText(tl_hero_style5_subtext, {
				type: "chars words",
			});
			...
			HomeDigital.from(
				split_tl_hero_style5_subtext.words,
				{
					duration: 1,
					x: 50,
					autoAlpha: 0,
