        ...
        <div className="container">
          ...
          <div className="tl_card_1_list">
            {banner_data.map((item, i) =>
              <div key={i} className="tl_card tl_style_1 anim_div_ShowDowns">
                <div className="tl_card_left">
                  <div className="tl_card_number tl_primary_font" style={{ backgroundImage: `url('/assets/img/hero_img_1.jpg')` }}>
                    0{i + 1}
                  </div>
                </div>
                <div className="tl_card_right">
                  <div className="tl_card_right_in">
                    ...
                    <div className="tl_card_subtitle">{item.description}</div>
                  </div>
                </div>
