  ...
  return (
    <>
      <div className="container">
        <div className="tl_newsletter tl_style_1 tl_primary_bg tl_shape_wrap_1 tl_parallax">
          ...
          <div className="tl_section_heading tl_style_1 tl_color_1 text-center">
            <div className="tl_section_heading_text">
              <h2 className="tl_section_title anim_text_upanddowns">
                Stay Ahead With Our Top Notch <br />Digital Services
              </h2>
            </div>
          </div>
          <div className="tl_height_70 tl_height_lg_40"></div>
          <form className="tl_newsletter_form" onSubmit={handleSuubmit}>
            <input type="text" className="tl_newsletter_input" placeholder="Enter Your Email" />
            <button className="tl_newsletter_btn">
