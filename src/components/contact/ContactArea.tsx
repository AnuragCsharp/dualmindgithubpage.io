                ...
                <form onClick={(e) => e.preventDefault()}>
                  <div className="row">
                    <div className="tl_field_group col">
                      <input
                        className="tl_input_field"
                        type="text"
                        id="test1"
                        placeholder="Name"
                        name="test"
                      />
                      <label htmlFor="test1" className="tl_input_label">
                        Name
                      </label>
                    </div>
                    <div className="tl_field_group col">
                      <input
                        ...
                        name="test"
                      />
                      <label htmlFor="test2" className="tl_input_label">
                        Email
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="row">
                    <div className="tl_field_group col">
                      <input
                        ...
                        name="test"
                      />
                      <label htmlFor="test3" className="tl_input_label">
                        Phone
                      </label>
                    </div>
                    <div className="tl_field_group col">
                      <input
                        ...
                        name="test"
                      />
                      <label htmlFor="test4" className="tl_input_label">
                        Subject
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="tl_field_group">
                    <input
                      ...
                      name="test"
                    />
                    <label htmlFor="test5" className="tl_input_label">
                      Message
                    </label>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="tl_btn tl_style_1 tl_type_btn"
                  >
                    <span>Send Now</span>
                    <svg
                      width="19"
                ...
                <div className="col-md-4">
                  <div className="tl_icon">
                    ...
                    <div className="tl_icon_text">
                      ...
                      <p className="tl_icon_subtitle">{site_info.address}</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="tl_icon">
                    <a href={`tel:${site_info.phone}`} className="tl_icon_style">
                      <i>
                        <svg
                          width="18"
                          height="19"
                    ...
                    <div className="tl_icon_text">
                      ...
                      <p className="tl_icon_subtitle">{site_info.phone}</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="tl_icon">
                    ...
                    <div className="tl_icon_text">
                      ...
                      <p className="tl_icon_subtitle">{site_info.email}</p>
                    </div>
                  </div>
                </div>
              </div>
