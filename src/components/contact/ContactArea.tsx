...
const ContactArea = () => {
  ...
  return (
    <>
      <div className="tl_height_150 tl_height_lg_120"></div>
      <section>
        <div className="container">
          <div className="tl_contact_ms">
            <div className="tl_contact">
              <div className="tl_contact_text">
                <p className="tl_contact_subtitle anim_text_upanddowns">
                  Contact Us
                </p>
                <h1 className="tl_contact_title anim_text_writting">
                  Get in Touch
                </h1>
              </div>
              <div className="tl_height_80 tl_height_lg_20"></div>
              <div className="tl_from anim_div_ShowDowns">
                <form onClick={e => e.preventDefault()}>
                  <div className="row">
                    <div className="tl_field_group col">
                      <input className="tl_input_field" type="text" id="test1" placeholder="Name"
                        name="test" />
                      <label htmlFor="test1" className="tl_input_label">Name</label>
                    </div>
                    <div className="tl_field_group col">
                      <input className="tl_input_field" type="text" id="test2" placeholder="Name"
                        name="test" />
                      <label htmlFor="test2" className="tl_input_label">Email</label>
                    </div>
                  </div>
                  <div className="tl_height_10 tl_height_lg_20"></div>
                  <div className="row">
                    <div className="tl_field_group col">
                      <input className="tl_input_field" type="text" id="test3" placeholder="Name"
                        name="test" />
                      <label htmlFor="test3" className="tl_input_label">Phone</label>
                    </div>
                    <div className="tl_field_group col">
                      <input className="tl_input_field" type="text" id="test4" placeholder="Name"
                        name="test" />
                      <label htmlFor="test4" className="tl_input_label">Subject</label>
                    </div>
                  </div>
                  <div className="tl_height_100 tl_height_lg_60"></div>
                  <div className="tl_field_group">
                    <input className="tl_input_field" type="text" id="test5" placeholder="Message"
                      name="test" />
                    <label htmlFor="test5" className="tl_input_label">Message</label>
                  </div>
                  <div className="tl_height_60 tl_height_lg_60"></div>
            ...
            <div className="tl_contact_section_2 anim_div_ShowRightSide">
              <div className="tl_google_map tl_bg" data-src="assets/img/map_img.png">
                <iframe
              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="tl_icon">
                    <a href="https://www.google.com/maps" className="tl_icon_style">
                      <i>
                    ...
                    <div className="tl_icon_text">
                      <h6 className="tl_icon_title">Address</h6>
                      <p className="tl_icon_subtitle">El-Mahalla El-Kubra 37</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="tl_icon">
                    <a href="tel:(406) 555-0120" className="tl_icon_style">
                      <i>
                    ...
                    <div className="tl_icon_text">
                      <h6 className="tl_icon_title">Phone</h6>
                      <p className="tl_icon_subtitle">(406) 555-0120</p>
                    </div>
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="tl_icon">
                    <a href="mailto:DualMind@email.com" className="tl_icon_style">
                      <i>
                    ...
                    <div className="tl_icon_text">
                      <h6 className="tl_icon_title">Email</h6>
                      <p className="tl_icon_subtitle">DualMind@email.com</p>
                    </div>
                  </div>
                </div>
              </div>
