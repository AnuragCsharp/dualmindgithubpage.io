...
const Testimonial = ({ style_service }: any) => {
  return (
    <>
      <section className={`${style_service ? 'tl_shape_wrap_3' : 'tl_primary_bg tl_shape_wrap_2'}`}>
        {style_service ? null :
          <>
        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-7 offset-lg-1">
              <div className={`tl_testimonial ${style_service ? 'tl_style_2' : 'tl_style_1 tl_color_1'}`}>
                ...
                <Swiper
                  ...
                  className="tl_slider tl_slider_4">
                  {testimonial_data.map((item, index) => (
                    <SwiperSlide key={index} className="swiper-slide">
                      <div className="tl_testimonial_box">
                        <div className="tl_testimonial_quote_icon">
                        ...
                        <blockquote className="tl_testimonial_text">
                          {item.des}
                        </blockquote>
                        <div className="tl_testimonial_meta">
                          <div className="tl_testimonial_avatar">
                            <Image src={item.img} alt="Avatar" />
                          </div>
                          <div className="tl_testimonial_meta_right">
                            <h3 className="tl_testimonial_avatar_name">
                              {item.name}
                            </h3>
                            <div className="tl_testimonial_avatar_designation">
                              {item.location}
                            </div>
                          </div>
                        </div>
        ...
        {style_service ? null : <div className="tl_height_150 tl_height_lg_60"></div>}
      </section>
      {style_service ? null : <div className="tl_height_115 tl_height_lg_60"></div>}
