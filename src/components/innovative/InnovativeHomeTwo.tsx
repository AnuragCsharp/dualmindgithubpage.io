		...
		<>
			...
			<section>
				<div className="container">
					<div className="tl_modern_needs tl_style">
						<div className="tl_col_md_778">
							<div className="tl_text">
								...
								<div className="tl_height_65"></div>
								<p className="anim_text">{des_1}</p>
							</div>
							<div className="tl_height_85"></div>
							<div className="row anim_div_ShowLeftSide">
								{features.map((item, i) => (
									<div className="col-md-4 col-12" key={i}>
										<div className="tl_stroke_text">
											<span>{item.id}</span>
										</div>
						...
						<div className="tl_col_md_672">
							<div className="tl_img_section">
								<Image src={image} alt="modern_digital_need" />
								<div className="tl_img_card_text anim_div_ShowZoom">
									<h6 className="tl_color_style">{title_2}</h6>
									<p>{des_2}</p>
								</div>
							</div>
						</div>
