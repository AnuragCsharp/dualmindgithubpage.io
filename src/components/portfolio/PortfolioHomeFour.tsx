    ...
    <>
      <section>
        <div className="container">
          ...
          <div className="tl_height_50 tl_height_lg_30"></div>
          <div className="row overflow-hidden">
            <div className="col-md-12">
              <div className="tl_creative_protfolio_menu anim_div_ShowZoom">
                <ul>
            ...
            <div>
              <div className="tl_creative_protfolio_details row">
                {items.map((item, i) => (
                  <React.Fragment key={i}>
                    <div className="col-md-4 mb-5 tl_project_card tl_ui_design tl_development anim_div_ShowDowns">
                      <Link href="/portfolio-details">
                        <div className="tl_project_card_img">
                          <Image src={item.img} alt="recent_project_1" />
                        </div>
                        <div className="tl_project_card_text">
                          <h6 className="tl_title">{item.title}</h6>
                          <p className="tl_subtitle">{item.subtitle}</p>
                        </div>
                      </Link>
                    </div> 
                  </React.Fragment>
