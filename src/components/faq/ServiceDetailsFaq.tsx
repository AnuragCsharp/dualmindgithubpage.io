  ...
  return (
    <>
      ...
      <div className="container">
        <div className="tl_service_details tl_type_2">
          <div className="tl_service_details_img">
            <div className="tl_accordeon">
              {faq_data.map((item, i) => (
                <div key={i}
                  onClick={() => toggleAccordion(i)}
                  className={`tl_accordion_item ${i === activeIndex ? 'active tl_icon' : ''}`}>
                  ...
                  <div className={`tl_accordion_body ${i === activeIndex ? '' : 'd-none'}`}>{item.answer}</div>
                </div>
              ))}
          ...
          <div className="tl_service_details_text">
            <div className="tl_specialization tl_section_heading tl_style_1">
              <div className="tl_section_heading_text">
                <h4 className="tl_section_title_4">{title}</h4>
              </div>
              <p>{description} </p>
              <div>
                <ul>
            ...
            <div className="tl_back_to_services_btn">
              <a href="#" className="tl_style_1">
